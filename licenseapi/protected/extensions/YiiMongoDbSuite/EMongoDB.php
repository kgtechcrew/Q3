...
class EMongoDB extends CApplicationComponent
{
	...
	public function connect()
	{
        ...
        public function autoLoadMongo()
        {
            spl_autoload_unregister(array('YiiBase', 'autoload'));

            Yii::import('application.vendors.composer.*');

            Yii::import('application.vendors.mongodb.*');
            Yii::import('application.vendors.mongodb.mongodb.*');
            Yii::import('application.vendors.mongodb.src.*');
            Yii::import('application.vendors.mongodb.src.Exception.*');
            Yii::import('application.vendors.mongodb.src.GridFS.*');
            Yii::import('application.vendors.mongodb.src.GridFS.Exception.*');
            Yii::import('application.vendors.mongodb.src.Operation.*');

            Yii::import('application.vendors.*');
            Yii::import('application.vendors.alcaeus.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.lib.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.lib.Alcaeus.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.lib.Alcaeus.MongoDbAdapter.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.lib.Alcaeus.MongoDbAdapter.Helper.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.lib.Mongo.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.tests.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.tests.Alcaeus.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.tests.Alcaeus.MongoDbAdapter.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.tests.Alcaeus.MongoDbAdapter.Mongo.*');
            Yii::import('application.vendors.alcaeus.mongo-php-adapter.tests.native.*');
